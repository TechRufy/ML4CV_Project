from ..utils.utils import IntermediateLayerGetter, DeepLabHeadV3Plus, DeepLabHead
...
def deeplabv3plus_embedding_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus_embedding', 'resnet101', num_classes, output_stride=output_stride,
                       pretrained_backbone=pretrained_backbone)
...
def deeplabv3plus_embedding_self_distillation_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus_embedding_self_distillation', 'resnet101', num_classes,

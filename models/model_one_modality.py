...
class OWSNetwork(nn.Module):
    def __init__(
        ...
        self.register_buffer('means_S', torch.zeros(num_classes, num_classes))
        self.register_buffer('variances_S', torch.ones(num_classes, num_classes))
        self.register_buffer('means_C', torch.zeros(num_classes, num_classes))
